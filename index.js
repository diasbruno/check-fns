...
const object = o => (b, smsg, merge = keepFirst) => Object.keys(o).reduce(
...
const ordobject = o => (b, smsg, merge = keepFirst) => {
...
const all = (...args) => (b, smsg, merge = keepFirst) => args.reduce(
...
const or = (...args) => (b, smsg, merge = keepFirst) => args.reduce(
  (acc, c) => {
...
const V = (f, s, m = keepFirst) => b => m(f(b, s, m), null);
